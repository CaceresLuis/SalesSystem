    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            List<Product> products = new()
            {
                ...
                new Product(new ProductId(Guid.NewGuid()), "CD de la banda sonora original de una película popular", "", 21, 485, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),
                ...
                new Product(new ProductId(Guid.NewGuid()), "Caja de té variado con sabores exóticos", "", 25, 740, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),
                new Product(new ProductId(Guid.NewGuid()), "Vino tinto reserva de una bodega reconocida", "", 128, 196, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),

                new Product(new ProductId(Guid.NewGuid()), "Set de suplementos vitamínicos para la salud general", "", 129, 504, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),
                ...
                new Product(new ProductId(Guid.NewGuid()), "Mascarilla facial de cuidado intensivo con ingredientes naturales", "", 234, 529, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),

                new Product(new ProductId(Guid.NewGuid()), "Kit de limpieza y cuidado automotriz de calidad profesional", "", 359, 74, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),
                new Product(new ProductId(Guid.NewGuid()), "Funda de asiento de cuero para automóvil", "", 75, 56, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),
                new Product(new ProductId(Guid.NewGuid()), "Casco de motocicleta de diseño aerodinámico y alta seguridad", "", 125, 142, DateTime.UtcNow, DateTime.MinValue, DateTime.MinValue, false, false),
            };
