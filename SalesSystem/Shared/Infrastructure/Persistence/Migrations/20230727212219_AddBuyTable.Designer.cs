...
namespace SalesSystem.shared.infrastructure.persistence.migrations
{
    ...
    [Migration("20230727212219_AddBuyTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesSystem.Modules.Users.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SalesSystem.Modules.Users.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SalesSystem.Modules.Users.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("SalesSystem.Modules.Users.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
